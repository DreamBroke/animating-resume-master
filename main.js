let resume = `# 杨金鑫-2年工作经验-Java开发工程师

18664364894 | yjx3427603@outlook.com | 深圳<br>
广西大学(211) | 2017届<br>
Github: https://github.com/DreamBroke | Blog: https://blog.csdn.net/a3427603<br>
动态简历：https://dreambroke.github.io/animating-resume-master/
...
- 成果：该功能由我单独负责，因为项目架构变动，经历过多次更新后，成功实现了在项目编译中生成一个临时数据库以供自动生成Model文件，而不会实际改变相应数据库，只有当项目在服务器中实际部署时，才会去自动修改相应数据库。
`;
